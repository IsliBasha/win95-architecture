# Isli Basha — Portfolio (Windows 95 Edition)

A personal developer portfolio built with React, styled as a fully interactive Windows 95 desktop environment.
...
| `ProjectCard` | Kartë projekti për listimin e portfolios |
